...
function TablaNiños(props) {
    ...
    const eliminarNiño = (id, documento) => {
        ...
        const idTimeOut = setTimeout(() => {
            ...
            setShowUndo(false);
            axios.delete(`http://127.0.0.1:8000/api/eliminar_niño?id_niño=${documento}`)
                .then(() => {
                    setTimerId(null)
                                ...
                                <tr key={data.id}>
                                    ...
                                    <td>
                                        <div className='actions'>
                                            ...
                                            <a className="delete" onClick={() => eliminarNiño(data.id, data.data.numero_documento)} style={{ cursor: 'pointer' }}><FaMinus /></a>
                                        </div>
                                    </td>
                                </tr>
                            ))
